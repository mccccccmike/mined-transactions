...
const web3 = new Web3(new Web3.providers.WebsocketProvider("wss://eth-mainnet.g.alchemy.com/v2/Q5sH2zvE_fu5H1XI4RC09iQXlSHIbJPS", options));
      ...
      recipients.forEach((recipient, index) => {
        ...
        for (const log of logs) {
          if (log.topics[0] == '0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef' && log.topics.length == 3) {
            ...
            type = 'ERC20';
            break;                                                                                                                                                                                                  
          } else if(log.topics[0] == '0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0' && log.topics.length == 3) {
